...
RUN wget -q --progress=bar:force:noscroll --show-progress https://github.com/IbcAlpha/IBC/releases/download/3.18.0/IBCLinux-3.18.0.zip -O ibc.zip
...
RUN mkdir .vnc
RUN x11vnc -storepasswd 888333 .vnc/passwd
